...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', description?: string | null, title: string, videoId: string, teacher?: { __typename?: 'Teacher', avatarURL: string, name: string, bio: string } | null } | null };
